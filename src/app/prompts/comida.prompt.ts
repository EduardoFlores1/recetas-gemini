...
La respuesta sólo debe ser un Objeto JSON con la siguiente estructura y sin las triples comillas:
{
...
}, si la imagen no se puede procesar como un plato de comida, manda solo un mensaje de no se pudo procesar
`
